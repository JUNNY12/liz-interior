...
const Section1  = () => {
  return (
    <div className='text-center p-10 md:p-28'>
        <h2 className='text-xl md:text-2xl lg:text-4xl mb-4 font-bold text-cyan-900' data-aos="fade-up-right">
             We specialize in interior design.
        </h2>

        <p className='text-lg md:text-xl text-gray-900 mb-6' data-aos="fade-down-left">
