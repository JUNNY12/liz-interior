  ...
  return (
    <div>
         <div className='text-center p-10 md:p-28 pt-20'>
            <h2 className='text-xl md:text-3xl lg:text-5xl font-bold mb-4 text-cyan-900' data-aos="fade-up">
                 Get to know the proprietor
            </h2>

            <p className='text-lg md:text-xl text-gray-900 mb-6' data-aos="fade-down">
